...
Use of **index.html** is a front-end user-facing file used for the gh-pages branch of the Repository.  The file is the Slidify presentation for this Android Project.  Press the link in the Description section of this Repository near the top of this page.